...
export const getAddressFromSigner = (ethersProvider) => {
	return getSigner(ethersProvider).address;
};

export const signedTypeData = (ethersProvider, domain, types, value) => {
	const signer = getSigner(ethersProvider);
...
export const sendTx = (ethersProvider, transaction) => {
	const signer = ethersProvider.getSigner();
	return signer.sendTransaction(transaction);
};

export const lensHub = (ethersProvider) =>
	new ethers.Contract(
				...
				inputs: [
					{
						components: [
							...
							},
							{
								...
								internalType:
									"struct DataTypes.EIP712Signature",
								name: "sig",
								type: "tuple",
							},
						],
				...
				inputs: [
					{
						...
						internalType:
							"struct DataTypes.SetFollowModuleWithSigData",
						name: "vars",
						type: "tuple",
					},
				],
				...
				inputs: [
					{
						...
						internalType:
							"struct DataTypes.SetFollowNFTURIWithSigData",
						name: "vars",
						type: "tuple",
					},
				],
				...
				inputs: [
					{
						...
						internalType:
							"struct DataTypes.SetProfileImageURIWithSigData",
						name: "vars",
						type: "tuple",
					},
				],
